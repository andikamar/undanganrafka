...
window.addEventListener('load', () => {
    ...
    if (name.length == 0) {
        ...
        div.innerHTML = `
        <p class="mt-0 mb-1 mx-0 p-0 text-light" style="color: #000080 !important;">Kepada Yth Bapak/Ibu/Saudara/i</p>
        <h2 class="text-light" style="color: #000080 !important;">${escapeHtml(name)}</h2>
        `;
